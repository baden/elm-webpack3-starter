...
(t, r, e) => {
    ...
    if (console.dir(o), o(document.getElementById("elm-app")), navigator.userAgent.match(/IEMobile\/10\.0/)) {
        var n = document.createElement("style");
        n.appendChild(document.createTextNode("@-ms-viewport{width:auto!important}")), document.head.appendChild(n);
    }
}, /* 1 */
/***/
() => {}, /* 2 */
